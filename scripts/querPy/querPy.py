...
def read_input(conf):
    ...
    def main(conf):
        ...
        logging.info(
            ...
            ": START OF INTERPRETATION OF FILE " +
            str(conf) +
            " ################\n")
        ...
        for i in range(0, len_queries):
            ...
            try:
                ...
                if query_title.isspace() or query_title == "":
                    query_title = "Q" + str(i + 1)
                else:
                    query_title = "Q" + str(i + 1) + " - " + conf.queries[i]["title"]
            except KeyError:
                query_title = "Q" + str(i + 1)
...
def execute_queries(data, output_writer):
    ...
    def main(data):
        ...
        for i in range(0, len(data['queries'])):
            ...
            # execute query
            data['queries'][i]['results_execution_timestamp'] = time.strftime('%Y-%m-%d_%H:%M:%S')
            ...
            logging.info("results_execution_timestamp: " + query['results_execution_timestamp'])
...
class OutputWriter:
    ...
    def __init__(self, data):
        ...
        def init_local_xlsx():
            ...
            self.xlsx_worksheet_summary = self.xlsx_workbook.add_worksheet("Q0 - Summary")
        ...
        def init_local_folder():
            ...
            self.file_xlsx = Path(self.folder / "Q0 - summary.xlsx")
            self.xlsx_workbook = xlsxwriter.Workbook(self.file_xlsx.open('wb'))
            self.xlsx_worksheet_summary = self.xlsx_workbook.add_worksheet("Q0 - Summary")
        ...
        def init_google_sheets():
            ...
            # rename summary sheet to 'Q0 - Summary'
            body_to_rename = {
                "requests" : [
                    {
    ...
    def write_header_summary(self, data):
        ...
        def write_header_summary_xlsx_file(data):
            ...
            message = "writing header to local xslx: '" + str(self.file_xlsx) + \
                      "' in local folder: " + str(self.folder)
            logging.info(message)
            print(message)
        ...
        def write_header_summary_google_sheet(data):
            ...
            message = "Writing header to google sheets"
            logging.info(message)
            print(message)
    ...
    def write_query_result(self, query):
        ...
        def write_query_result_to_xlsx_file(query):
            ...
            message = "writing result of query: '" + query['query_title'] + \
                      "' to local xslx: '" + str(self.file_xlsx) + "'"
            logging.info(message)
            print(message)
        ...
        def write_query_result_to_local_folder(query):
            ...
            message = "writing result of query: '" + query['query_title'] + \
                      " to local folder: '" + str(self.folder)
            logging.info(message)
            print(message)
    ...
    def write_query_summary(self, query):
        ...
        def write_query_summary_google_sheets(query):
            ...
            message = "Writing summary of query result to google sheets"
            logging.info(message)
            print(message)
            ...
            google_sheet_range = "Q0 - Summary!" + google_sheet_range
