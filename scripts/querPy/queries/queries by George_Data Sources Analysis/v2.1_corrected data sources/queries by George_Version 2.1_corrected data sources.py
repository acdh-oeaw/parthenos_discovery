...
title = [
["CLARIN", "PARTHENOS", "Huma-Num - Nakala", "Huma-Num - Isidore", "European Holocaust Research Infrastructure", "ARIADNE", "Cultura Italia", "METASHARE", "LRE MAP"],
": Metadata analysis"
]
...
description = r"Same queries as in V2, except for some errors which are corrected (e.g. 'METASHARE' instead of 'Metashare' and 'Huma-Num - Nakala' instead of 'Nakala'. Also included other data sources as provided by first query. Queries by George are originaly defined here: https://services.d4science.org/group/d4science-services-gateway/workspace?itemid=84e187f3-44aa-4df2-8e83-a92957455be0&operation=gotofolder , descriptions available here: https://docs.google.com/document/d/1diQQmN8tCXohNtHYqf-KVatb1jhTiILoBXHspF2c-y0/edit"
...
output_destination = r"https://drive.google.com/drive/folders/1MAQavVwHBEwHq1YYhpkpMWzqGfldkm3D"
...
queries = [

    {
        ...
        # description
        # OPTIONAL, if not set, nothing will be used or displayed
        "description" : "Show which data sources are there." ,
