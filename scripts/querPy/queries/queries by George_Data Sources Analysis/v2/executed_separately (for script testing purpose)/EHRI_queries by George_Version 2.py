...
title = "EHRI: Metadata quality on virtuoso"
...
output_destination = r"https://drive.google.com/drive/folders/1GHWAKng3qR5zDIF-AiIzD7Q1iahFKwwA"
...
queries = [
...

    {
        ...
        "query" : [r"""
			...
			GRAPH <provenance> {
			values ?ds { 'EHRI'^^<http://www.w3.org/2001/XMLSchema#string> }
    ...
    },
    {
        ...
        "query" : [r"""
			...
			GRAPH <provenance> {?gRecord <dnetcollectedFrom> ?api . ?api <dnetisApiOf> 'EHRI'^^<http://www.w3.org/2001/XMLSchema#string>}
			}
