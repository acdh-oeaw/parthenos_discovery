...
output_destination = r"https://drive.google.com/drive/folders/1fL5Oz3pMZK9OsipkqYGfOtDqkKALH1_I"
...
queries = [
    ...
    {
		"title" : "class_population_overall_V.1.3",
    ...
    {
		"title" : "class_population_PE_top_V.1.1",
    ...
    {
		"title" : "class_population_PE_top_overall_V.1.1",
    ...
    {
		"title" : "place_instances_count_V1.0",
    ...
    {
		"title" : "place_instances_count_overall_V1.0",
		"description" : "This query gives the list of instances of E53 class existing in a data source and the number of times it is used.",
		"query" : [
			r"""
			#7b ############ Get the Places instances COUNT per Datasource ###########
    ...
    {
		"title" : "periods_and_events_count_V1.0",
    ...
    {
		"title" : "periods_and_events_count_overall_V1.0",
