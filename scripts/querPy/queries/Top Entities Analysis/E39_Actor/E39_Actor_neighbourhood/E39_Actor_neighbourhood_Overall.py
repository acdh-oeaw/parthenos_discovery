...
title = "E39_Actor_neighbourhood_Overall"
...
queries = [
    {
        ...
        "query" : r"""
            ...
            where {
                # explicit graph context, for performance and integrity reasons (otherwise weird cross products are generated)
                graph ?sourceGraph {
            
                    # subquery to get the correct distinct i without having the rest of the sub result intefering with the rest:
                    {
                        graph ?sourceGraph {
        ...
        "query": r"""
            ...
            where {
                ...
                graph ?sourceGraph {
                    ...
                    # subquery to get the correct distinct ir without having the rest of the sub result intefering with the rest:
                    {
                        graph ?sourceGraph {
    ...
    },
    {
        ...
        "query": r"""
            ...
            where {
                # explicit graph context, for performance and integrity reasons (otherwise weird cross products are generated)
                graph ?sourceGraph {
                    # subquery to get the correct distinct il without having the rest of the sub result intefering with the rest:
                    {
                        graph ?sourceGraph {
